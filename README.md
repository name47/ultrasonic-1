...
> Άνοιγμα αυτής της σελίδας στο [https://name47.github.io/ultrasonic-1/](https://name47.github.io/ultrasonic-1/)
...
* αναζήτηση για **https://github.com/name47/ultrasonic-1** και εισαγωγή

## Επεξεργασία αυτού του έργου ![Σήμα κατάστασης κατασκευής](https://github.com/name47/ultrasonic-1/workflows/MakeCode/badge.svg)

Για επεξεργασία αυτού του αποθετηρίου στο MakeCode.

* άνοιγμα [https://makecode.microbit.org/](https://makecode.microbit.org/)
* κάντε κλικ στην **Εισαγωγή** και έπειτα στην **Εισαγωγή διεύθυνσης URL**
* επικολλήστε **https://github.com/name47/ultrasonic-1** και κάντε κλικ στην εισαγωγή
...
![Προβολή απόδοσης των μπλοκ](https://github.com/name47/ultrasonic-1/raw/master/.github/makecode/blocks.png)
